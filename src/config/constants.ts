...
export const SPECIALIZATION_LIMITS = {
  NAME_MAX: 60,
  DESCRIPTION_MAX: 300,
} as const
...
export const AUDIT_ACTIONS = {
  ...
  HR_PROFILE_APPROVED: 'HR_PROFILE_APPROVED',
  HR_PROFILE_REJECTED: 'HR_PROFILE_REJECTED',
...
export const ADMIN_LIMITS = {
  ...
  SUSPEND_REASON_MAX: 300,
  RESOLUTION_NOTES_MAX: 500,
